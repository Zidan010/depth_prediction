...
def setup_logger(log_file='inference_log'):
    logger = logging.getLogger("depth_prediction_inference")
...
def test_simple(args):
    ...
    assert (
        args.model_name is not None or args.model_path is not None
