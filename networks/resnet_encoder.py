...
def resnet_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    # return model
    if pretrained:
        # UPDATE START: Use Weights Enum instead of model_urls
        if num_layers == 18:
            weights = models.ResNet18_Weights.IMAGENET1K_V1
        else:
            weights = models.ResNet50_Weights.IMAGENET1K_V1
            
        loaded = model_zoo.load_url(weights.url)
        # UPDATE END
...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, num_input_images=1):
        ...
        if num_input_images > 1:
            ...
            # UPDATE START: Use weights= instead of pretrained=
            if pretrained:
                # Map the layer count to the specific weight enum
                weight_map = {
                ...
                self.encoder = resnets[num_layers](weights=weight_map[num_layers])
            else:
